...
import wasif.whatevervalue.com.instagramclone.Share.NextActivity;
import wasif.whatevervalue.com.instagramclone.Share.ShareActivity;
import wasif.whatevervalue.com.instagramclone.Utils.Permissions;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnLaunchCamera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(((HomeActivity)getActivity()).getCurrentTabNumber() == PHOTO_FRAGMENT_NUM){
                    if(((HomeActivity)getActivity()).checkPermissions(Permissions.CAMERA_PERMISSION[0])){
