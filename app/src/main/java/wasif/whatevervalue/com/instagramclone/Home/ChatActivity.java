...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRootRef.child("user_account_settings").child(mChatUser).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {

                String userThumb = dataSnapshot.child("profile_photo").getValue().toString();
                setUserImage(userThumb,ChatActivity.this);
    ...
    public void setUserImage(String thumb_image, Context ctx){
        ...
        CircleImageView userImageView = (CircleImageView) findViewById(R.id.custom_bar_image);
