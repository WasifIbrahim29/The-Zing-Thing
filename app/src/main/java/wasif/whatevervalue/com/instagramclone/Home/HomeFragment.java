            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    for ( DataSnapshot singleSnapshot :  dataSnapshot.getChildren()){
                        ...
                        Log.d(TAG, "onDataChange: "+ mFollowing.size());
                    }
...
//        mPaginatedPhotos = new ArrayList<>();
        Log.d(TAG, "displayPhotos: so I am here now" );
        if(mPhotos != null){
...
//
                ...
                adapter = new MainfeedListAdapter(Objects.requireNonNull(getActivity()), R.layout.layout_mainfeed_listitem, mPaginatedPhotos);
                mListView.setAdapter(adapter);
                Log.d(TAG, "displayPhotos: after thiss");
